...
/**
 * Permission granted by Professor Richard Baldwin to
 * use this class from the following website:
 * developer.com/java/other/article.php/3436341/Spectrum-Analysis-Using-Java
 * @author Professor Richard Baldwin
 *
 */
public class FFT {
