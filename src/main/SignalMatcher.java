...
public class SignalMatcher {
	...
	private static int EUCLIDIAN_DISTANCE_MAX = 6000;
	//private static final int ACCEPTABLE_HASH_RANGE = 1000;
	private static final int ACCEPTABLE_HASH_RANGE = 2000;
	...
	private static ArrayList<Fingerprint> scanMap(HashMap<Integer, 
			Fingerprint> map, int hash, ArrayList<String> prevMatches){
	...
	private static boolean chainCompare(Fingerprint f1, 
		...
		if(f1.getName().equals("Piste1.wav") && f2.getName().equals("Mpmm.wav")){
			}
